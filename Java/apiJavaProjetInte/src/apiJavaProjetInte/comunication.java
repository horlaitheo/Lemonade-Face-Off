...
public class comunication {
	 ...
	 * int responseCode variable qui récupère le code retour émise par le serveur lors de la requête
	 */
	ArrayList GetWeather() throws Exception {
			...
			list.add(entjson.getString("weather"));
	 ...
	 */
		...
		private void sendPost(String name,String recipe,int quantity) throws Exception {
			
			JSONObject sales= new JSONObject("{'sales':{'player':"+name+",'items':"+recipe+",'quantity':"+quantity+"}}"); /**Déclaration d'une nouvelle instance de la classe JSONObject */
